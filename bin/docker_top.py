    ...
    for container_id in ps_parsed:
        ...
        if top_parsed:
            for line in top_parsed:
                ...
                print('%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,"%s"' % (ts, container_id, pid, user, priority, nice, mem_virt_bytes, mem_res_bytes, mem_shr_bytes, status, cpu_perc, mem_perc, timestamp, command))
